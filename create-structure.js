...
function createProjectStructure(name) {
  ...
  createFile(path.join(configurationPath, `${name}-configuration.ts`), configContent());
      ...
      <p-panel [toggleable]="true" expandIcon="pi pi-chevron-up" collapseIcon="pi pi-chevron-down"
        ...
        <div class="grid formgrid">
          <div class="col-12 md:col-6">
            <div class="field">
              <label for="bankCode" class="col-12 md:col-3">{{ 'Carriers.bankCode' | translate }}</label>
              <div class="col-12 md:col-10">
                <input formControlName="bankCode" type="text" id="bankCode" pInputText class="p-inputtext-sm w-full" />
              </div>
            </div>
          </div>
          ...
          <div class="col-12 md:col-6">
            <div class="field">
              <label for="abi" class="col-12 md:col-3">{{ 'Carriers.abi' | translate
                }}</label>
              <div class="col-12 md:col-10">
                <input formControlName="abi" type="text" id="abi" pInputText class="p-inputtext-sm w-full" />
              </div>
            </div>
